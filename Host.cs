...
namespace Celnet.ENet
{
    public class Host : IDisposable
    {
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            {
                C.enet_host_destroy(nativeHost);
        ...
        public uint PeersCount
        {
            get
            {
                ...
                return C.enet_host_get_peers_count(nativeHost);
            }
        }
        ...
        public uint PacketsSent
        {
            get
            {
                ...
                return C.enet_host_get_packets_sent(nativeHost);
            }
        }
        ...
        public uint PacketsReceived
        {
            get
            {
                ...
                return C.enet_host_get_packets_received(nativeHost);
            }
        }
        ...
        public uint BytesSent
        {
            get
            {
                ...
                return C.enet_host_get_bytes_sent(nativeHost);
            }
        }
        ...
        public uint BytesReceived
        {
            get
            {
                ...
                return C.enet_host_get_bytes_received(nativeHost);
            }
        }
            ...
            uint outgoingBandwidth, int bufferSize)
        {
            ...
            if (address != null)
            {
                ...
                nativeHost = C.enet_host_create(ref nativeAddress, (IntPtr)peerLimit, (IntPtr)channelLimit,
                    incomingBandwidth, outgoingBandwidth, bufferSize);
            }
            else
            {
                nativeHost = C.enet_host_create(IntPtr.Zero, (IntPtr)peerLimit, (IntPtr)channelLimit,
                    incomingBandwidth, outgoingBandwidth, bufferSize);
            }
        ...
        public void PreventConnections(bool state)
        {
            ...
            C.enet_host_prevent_connections(nativeHost, (byte)(state ? 1 : 0));
        }
        ...
        public void Broadcast(byte channelID, ref Packet packet)
        {
            ...
            C.enet_host_broadcast(nativeHost, channelID, packet.NativeData);
        ...
        public void Broadcast(byte channelID, ref Packet packet, Peer excludedPeer)
        {
            ...
            packet.ThrowIfNotCreated();
            C.enet_host_broadcast_exclude(nativeHost, channelID, packet.NativeData, excludedPeer.NativeData);
            packet.NativeData = IntPtr.Zero;
        }
        ...
        public void Broadcast(byte channelID, ref Packet packet, Peer[] peers)
        {
            ...
            if (peers.Length > 0)
            {
                ...
                C.enet_host_broadcast_selective(nativeHost, channelID, packet.NativeData, nativePeers,
                    (IntPtr)nativeCount);
                packet.NativeData = IntPtr.Zero;
            }
            else
        ...
        public int CheckEvents(out Event @event)
        {
            ...
            var result = C.enet_host_check_events(nativeHost, out nativeEvent);
        ...
        public Peer Connect(Address address, int channelLimit, uint data)
        {
            ...
            var peer = new Peer(C.enet_host_connect(nativeHost, ref nativeAddress, (IntPtr)channelLimit, data));
        ...
        public int Service(int timeout, out Event @event)
        {
            ...
            var result = C.enet_host_service(nativeHost, out nativeEvent, (uint)timeout);
        ...
        public void SetBandwidthLimit(uint incomingBandwidth, uint outgoingBandwidth)
        {
            ...
            C.enet_host_bandwidth_limit(nativeHost, incomingBandwidth, outgoingBandwidth);
        }
        ...
        public void SetChannelLimit(int channelLimit)
        {
            ...
            C.enet_host_channel_limit(nativeHost, (IntPtr)channelLimit);
        }
        ...
        public void SetMaxDuplicatePeers(ushort number)
        {
            ...
            C.enet_host_set_max_duplicate_peers(nativeHost, number);
        }
        ...
        public void SetInterceptCallback(IntPtr callback)
        {
            ...
            C.enet_host_set_intercept_callback(nativeHost, callback);
        }
        ...
        public void SetInterceptCallback(InterceptCallback callback)
        {
            ...
            C.enet_host_set_intercept_callback(nativeHost, Marshal.GetFunctionPointerForDelegate(callback));
        }
        ...
        public void SetChecksumCallback(IntPtr callback)
        {
            ...
            C.enet_host_set_checksum_callback(nativeHost, callback);
        }
        ...
        public void SetChecksumCallback(ChecksumCallback callback)
        {
            ...
            C.enet_host_set_checksum_callback(nativeHost, Marshal.GetFunctionPointerForDelegate(callback));
        }

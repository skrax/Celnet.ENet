...
namespace Celnet.ENet
{
    public struct Packet : IDisposable
    {
        ...
        public void Dispose()
        {
            ...
            {
                C.enet_packet_dispose(nativePacket);
        ...
        public IntPtr Data
        {
            get
            {
                ...
                return C.enet_packet_get_data(nativePacket);
            }
        }
        ...
        public IntPtr UserData
        {
            get
            {
                ...
                return C.enet_packet_get_user_data(nativePacket);
            }
            ...
            set
            {
                ...
                C.enet_packet_set_user_data(nativePacket, value);
            }
        }
        ...
        public int Length
        {
            get
            {
                ...
                return C.enet_packet_get_length(nativePacket);
            }
        }
        ...
        public bool HasReferences
        {
            get
            {
                ...
                return C.enet_packet_check_references(nativePacket) != 0;
            }
        }
        ...
        public void SetFreeCallback(IntPtr callback)
        {
            ...
            C.enet_packet_set_free_callback(nativePacket, callback);
        }
        ...
        public void SetFreeCallback(PacketFreeCallback callback)
        {
            ...
            C.enet_packet_set_free_callback(nativePacket, Marshal.GetFunctionPointerForDelegate(callback));
        }
        ...
        public void Create(byte[] data, int length, PacketFlags flags)
        {
            ...
            nativePacket = C.enet_packet_create(data, (IntPtr)length, flags);
        }
        ...
        public void Create(byte[] data, int offset, int length, PacketFlags flags)
        {
            ...
            nativePacket = C.enet_packet_create_offset(data, (IntPtr)length, (IntPtr)offset, flags);
        }

...
namespace Celnet.ENet
{
    public struct Address
    {
        ...
        public string GetIP()
        {
            ...
            if (C.enet_address_get_ip(ref nativeAddress, ip, (IntPtr)ip.Capacity) != 0)
                return String.Empty;
        ...
        public bool SetIP(string ip)
        {
            ...
            return C.enet_address_set_ip(ref nativeAddress, ip) == 0;
        }
        ...
        public string GetHost()
        {
            ...
            if (C.enet_address_get_hostname(ref nativeAddress, hostName, (IntPtr)hostName.Capacity) != 0)
                return String.Empty;
        ...
        public bool SetHost(string hostName)
        {
            ...
            return C.enet_address_set_hostname(ref nativeAddress, hostName) == 0;
        }
    }
}